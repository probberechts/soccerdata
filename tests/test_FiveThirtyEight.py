...
def test_read_leagues(five38_laliga: FiveThirtyEight):
...
def test_read_games(five38_laliga: FiveThirtyEight):
    assert isinstance(five38_laliga.read_games(), pd.DataFrame)


def test_read_forecasts(five38_laliga: FiveThirtyEight):
    assert isinstance(five38_laliga.read_forecasts(), pd.DataFrame)


def test_read_clinches(five38_laliga: FiveThirtyEight):
    assert isinstance(five38_laliga.read_clinches(), pd.DataFrame)


def test_filter_leagues(five38: FiveThirtyEight):
...
def test_init_league_value_error():
    with pytest.raises(ValueError):
        FiveThirtyEight('xxx')


def test_init_league_type_error():
